...
const BlogDetails = ({ data, blogData }) => {
	...
	return (
		<>
			...
			<div className="blog-title-background py-md-5">
				<div className="container py-5">
					<h1 className="text-center text-white">
						{currentBlog?.title || newBlog?.title}
					</h1>
				</div>
			</div>
							...
							<div className="boxShadow border py-3 px-md-5 px-3">
								...
								<div className="d-flex align-items-center justify-content-evenly mt-4 ">
									<p style={{ fontSize: "14px" }}>
										...
										{currentBlog?.writerName || newBlog?.writerName}
									</p>
									<p style={{ fontSize: "14px" }}>
										{" "}
								...
								<div className="table-of-content cursor-pointer d-inline-block">
									{ReactHtmlParser(
										currentBlog?.tableOfContent || newBlog?.tableOfContent
									)}
								</div>
								...
								<div className="fs-14 lh-36 text-justify mb-5">
									{ReactHtmlParser(
										currentBlog?.description || newBlog?.description
									)}
								</div>
								...
								<div className="fs-14 lh-36 text-justify">
			...
			<div className={`position-fixed bg-light rounded m-3 shadow-lg py-3 left-0 top-30`}>
				<FacebookShareButton url="https://virtualexperts.net/" className="d-block p-2">
        ...
        >
          <RedditIcon size={32} round={true} />
				...
				<TwitterShareButton url="https://virtualexperts.net/" className="d-block p-2">
