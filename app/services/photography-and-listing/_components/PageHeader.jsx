	...
	return (
		<div className="page-header">
			<div className="container">
				<div className="flex items-center gap-x-8 gap-y-10">
					<div className="text-content max-w-[690px] space-y-4">
						<h2 className="text-4xl font-bold">
							Worried About Amazon Listing Images Design? <span>Maximize</span> Your
							Amazon Sales with{" "}
							<span className="text-orange-400">Expert Listing Images Design.</span>
						</h2>
						...
						<div className="flex flex-wrap items-center gap-x-3 gap-y-3">
							<Link href="/" className="btn btn-dark rounded-lg">
								Get a Free Quote
							</Link>
